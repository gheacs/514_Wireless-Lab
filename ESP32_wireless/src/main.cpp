...
static BLEUUID serviceUUID("b35dfc93-7465-46ab-aabe-836ea37f4da2");
// The characteristic of the remote service we are interested in.
static BLEUUID    charUUID("9ecf105c-fb50-4507-bf0b-7faedb3e3b49");
...
void processData(uint8_t* pData, size_t length) {
  // TODO: Extract the distance data from pData and update currentDistance
  // ...
    if (length == 4) { // 假设数据长度为4字节（32位整数）
    int32_t distanceValue;
    memcpy(&distanceValue, pData, sizeof(distanceValue));
...
void loop() {
  ...
  // Print currently receiving data, maximum, and minimum data on the serial monitor every time new data is received
